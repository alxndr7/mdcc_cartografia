...
map.getView().fit([-7975583.364554, -1846883.222478, -7966386.058175, -1840050.937739], map.getSize());
...
var onSingleClick = function(evt) {
    ...
    map.forEachFeatureAtPixel(pixel, function(feature, layer) {
        ...
        if(lyr_sectores_cat1 == layer){
            //alert(currentFeatureKeys);
            new_dlg_map(currentFeature);
            //alert("Codigo: " + currentFeature.get('codigo') + "// Sector: " + currentFeature.get('sector'));
/*
                popupField += '<tr>' + "CODIGO: " + currentFeature.get('codigo') + ':</tr>';
                popupField += '<tr><strong>' + "SECTOR:" +  currentFeature.get('sector') + ':</strong></tr>';
                popupField +=  "<tr> ID: " + currentFeature.get('gid') + '</tr>';
                popupText = popupText + '<tr>' + popupField + '</tr>';
                popupText = popupText + '</table>';
